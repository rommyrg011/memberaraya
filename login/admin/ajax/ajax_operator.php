...
$columnNames = [
    'id_user', 'nama_lengkap', 'cabang', 'username', 'password'
];
...
while($user = mysqli_fetch_assoc($userRecords)){
    ...
    $opsi_tombol = "<a href='ajax/operator_hapus?id=" . $user['id_user'] . "' class='btn btn-danger btn-sm btn-xs' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'><i class='fas fa-trash'></i></a>";
