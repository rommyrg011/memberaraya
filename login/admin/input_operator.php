                        ...
                        <form method="post" autocomplete="off">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select type="text" class="form-control" name="cabang" required>
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <button type="submit" class="btn btn-primary btn-sm mr-2" name="tambahOperator">Submit</button>
                                    <a href="operator" type="button" class="btn btn-secondary btn-sm mr-2">Kembali</a>
                                </div>
                            </div>
                        </form>
                    </div>
